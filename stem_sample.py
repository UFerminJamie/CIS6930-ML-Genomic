...
if __name__ == "__main__":
    ...
    # model parameters
    parser.add_argument("--model", type=str, choices=list(models.keys()), default="Stem")
    ...
    # model checkpoint
    args.ckpt = './kidney_results/runs/005/checkpoints/0087500.pt'
    args.save_path = './kidney_results/runs/005/samples/'
